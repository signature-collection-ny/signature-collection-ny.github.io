(()=>{
  ...
  async function submitOrder(event){
    event.preventDefault();const form=event.currentTarget,status=document.getElementById("orderStatus"),submit=form.querySelector(".order-submit");
    ...
    }finally{submit.disabled=false;submit.textContent="EMAIL ORDER REQUEST"}
  }
